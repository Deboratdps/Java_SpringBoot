...
public class FuncionarioEncap {
	...
	public FuncionarioEncap(int id, String nome, Date dataAdmissao, float salario) {
		this.id = id;
		this.nome = nome;
	...
	public FuncionarioEncap(int id, String nome, Date dataAdmissao, float salario, Date desligamento) {
		this.id = id;
		this.nome = nome;
		this.dataAdmissao = dataAdmissao;
		this.salario = salario;
	...
	public String toString() {
		...
		if (desligamento == null) {
			return "\n"+nome+", prontuário "+id+" trabalha desde "+f.format(dataAdmissao)+", há "
					+tempoServico(dataAdmissao)+" anos, com salário de R$"+String.format("%.2f", salario)
					+".\n";
		}
		else {
			return "\n"+nome+", prontuário "+id+" trabalhou de "+f.format(dataAdmissao)+", até "
